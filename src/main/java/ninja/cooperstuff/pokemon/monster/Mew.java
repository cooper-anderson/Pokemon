...
public class Mew extends Monster {
	public Mew(String name, Type type1, Type type2, int health, int attackPhysical, int attackSpecial, int defensePhysical, int defenseSpecial, int speed) {
